---
title: Commands List
desc: (legacy @quasar/app-webpack v3) The entire list of Quasar CLI commands.
---
...
## Ext
This command is used to manage [App Extensions](https://v2.quasar.dev/app-extensions/introduction).
...
## Run
This command is used to run commands supplied by the [App Extensions](https://v2.quasar.dev/app-extensions/introduction) that you've installed into your project folder.
