...
desc: (legacy @quasar/app-webpack v3) Where, how and what you can configure in a Quasar app.
---
...
* Default [Quasar Language Pack](https://v2.quasar.dev/options/quasar-language-packs)
* [Icon libraries](https://v2.quasar.dev/options/installing-icon-libraries) that you wish to use
* Default [Quasar Icon Set](https://v2.quasar.dev/options/quasar-icon-sets) for Quasar components
* Development server port, HTTPS mode, hostname and so on
* [CSS animations](https://v2.quasar.dev/options/animations) that you wish to use
* [Boot Files](/quasar-cli-webpack-v3/boot-files) list (that determines order of execution too) -- which are files in `/src/boot` that tell how your app is initialized before mounting the root Vue component
* Global CSS/Sass/... files to be included in the bundle
* PWA [manifest](/quasar-cli-webpack-v3/developing-pwa/configuring-pwa#Configuring-Manifest-File) and [Workbox options](/quasar-cli-webpack-v3/developing-pwa/configuring-pwa#quasar-config-file)
* [Electron Packager](/quasar-cli-webpack-v3/developing-electron-apps/configuring-electron#quasar-config-file) and/or [Electron Builder](/quasar-cli-webpack-v3/developing-electron-apps/configuring-electron#quasar-config-file)
...
| preFetch | Boolean | Enable [PreFetch Feature](/quasar-cli-webpack-v3/prefetch-feature). |
...
| supportTS | Boolean/Object | Add support for TypeScript. [More info](/quasar-cli-webpack-v3/supporting-ts) |
...
| animations | Object/String | What [CSS animations](https://v2.quasar.dev/options/animations) to import. Example: _['bounceInLeft', 'bounceOutRight']_ |
...
| cordova | Object | Cordova specific [config](/quasar-cli-webpack-v3/developing-cordova-apps/configuring-cordova). |
| capacitor | Object | Quasar CLI Capacitor specific [config](/quasar-cli-webpack-v3/developing-capacitor-apps/configuring-capacitor). |
| pwa | Object | PWA specific [config](/quasar-cli-webpack-v3/developing-pwa/configuring-pwa). |
...
Please refer to [Adding to process.env](/quasar-cli-webpack-v3/handling-process-env#adding-to-process-env) section in our docs.

### Handling Webpack configuration
In depth analysis on [Handling Webpack](/quasar-cli-webpack-v3/handling-webpack) documentation page.
